...
import { extractIds, buildApplyToText } from "../../utils/business-logic/autoRuleUtils";
...
const getInitialFormData = (editingRule) => {
  if (editingRule) {
    ...
    return {
      ...
      // Nếu rule gốc không có conditions (hoặc mảng rỗng) thì form update cũng không hiển thị điều kiện nào
      conditions:
