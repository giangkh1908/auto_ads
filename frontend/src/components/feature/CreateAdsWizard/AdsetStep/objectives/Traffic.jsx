  ...
  sections: [
    {
      ...
      fields: [
        ...
        {
          type: "info",
          content: "💡 Quảng cáo TRAFFIC cần Trang Facebook để tạo nội dung Creative. Trang này sẽ được chọn ở phần 'Trang Facebook' phía trên.",
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          label: "Chọn nơi bạn muốn thúc đẩy lưu lượng truy cập",
          options: (objective, adset) => {
            // Nếu optimization_goal là CONVERSATIONS, chỉ hiển thị MESSENGER
            if (adset?.optimization_goal === "CONVERSATIONS") {
              return [
                { value: "MESSENGER", label: "Messenger", icon: "MessageSquare" },
              ];
            }
            // Các trường hợp khác, hiển thị tất cả options
            return [
        ...
        },
        {
          ...
          visibleIf: (adset) => adset.traffic_destination === "APP",
        },
        {
          type: "input",
        ...
        },
        {
          ...
          visibleIf: (adset) => adset.traffic_destination === "WEBSITE" && adset.optimization_goal === "LANDING_PAGE_VIEWS",
        },
      ],
    },
    {
