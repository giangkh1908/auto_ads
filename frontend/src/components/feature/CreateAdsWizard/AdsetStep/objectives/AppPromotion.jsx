  ...
  sections: [
    {
      ...
      fields: [
        ...
        {
          type: "info",
          content: "💡 Quảng cáo APP_PROMOTION cần Trang Facebook để tạo nội dung Creative. Trang này sẽ được chọn ở phần 'Trang Facebook' phía trên.",
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          placeholder: "Nhập Application ID",
          validate: (value) => {
            if (!value) {
              return "Application ID là bắt buộc cho chiến dịch App Promotion";
            }
            return true;
          },
        },
        {
          ...
          validate: (value) => {
            if (!value) {
              return "URL App Store là bắt buộc";
            }
            return true;
          },
        },
...
export default AppPromotionSchema;
